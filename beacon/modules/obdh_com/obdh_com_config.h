...
#define OBDH_COM_SOLAR_PANELS_CURRENTS_POS  (OBDH_COM_BAT2_VOLTAGE_POS + OBDH_COM_BAT2_VOLTAGE_LEN)
...
#define OBDH_COM_BAT1_TEMPERATURE_POS       (OBDH_COM_SOLAR_PANELS_VOLTAGES_POS + OBDH_COM_SOLAR_PANELS_VOLTAGES_LEN)
...
#define OBDH_COM_IMU_POS                    (OBDH_COM_BAT2_TEMPERATURE_POS + OBDH_COM_BAT2_TEMPERATURE_LEN)

// Battery 1 Charge
#define OBDH_COM_BAT1_CHARGE_LEN            2
#define OBDH_COM_BAT1_CHARGE_POS            (OBDH_COM_IMU_POS + OBDH_COM_IMU_LEN)

// Battery 2 Charge
#define OBDH_COM_BAT2_CHARGE_LEN            2
#define OBDH_COM_BAT2_CHARGE_POS            (OBDH_COM_BAT1_CHARGE_POS + OBDH_COM_BAT1_CHARGE_LEN)

// System Time
#define OBDH_COM_SYSTEM_TIME_LEN            4
#define OBDH_COM_SYSTEM_TIME_POS            (OBDH_COM_BAT2_CHARGE_POS + OBDH_COM_BAT2_CHARGE_LEN)

// Satellite Status
#define OBDH_COM_SAT_STATUS_LEN             2
#define OBDH_COM_SAT_STATUS_POS             (OBDH_COM_SYSTEM_TIME_POS + OBDH_COM_SYSTEM_TIME_LEN)

// OBDH Reset Counter
#define OBDH_COM_RESET_COUNTER_LEN          2
#define OBDH_COM_RESET_COUNTER_POS          (OBDH_COM_SAT_STATUS_POS + OBDH_COM_SAT_STATUS_LEN)
