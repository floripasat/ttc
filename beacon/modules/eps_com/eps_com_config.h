...
// Battery 1 Charge
#define EPS_COM_BAT1_CHARGE_LEN             1
#define EPS_COM_BAT1_CHARGE_POS             (EPS_COM_BAT2_VOLTAGE_POS + EPS_COM_BAT2_VOLTAGE_LEN)

// Battery 2 Charge
#define EPS_COM_BAT2_CHARGE_LEN             1
#define EPS_COM_BAT2_CHARGE_POS             (EPS_COM_BAT1_CHARGE_POS + EPS_COM_BAT1_CHARGE_LEN)

// Battery 1 Temperature
#define EPS_COM_BAT1_TEMPERATURE_LEN        3
#define EPS_COM_BAT1_TEMPERATURE_POS        (EPS_COM_BAT2_CHARGE_POS + EPS_COM_BAT2_CHARGE_LEN)
...
#define EPS_COM_SOLAR_PANELS_VOLTAGES_POS   (EPS_COM_BAT2_TEMPERATURE_POS + EPS_COM_BAT2_TEMPERATURE_LEN)

// Solar Panels Currents
#define EPS_COM_SOLAR_PANELS_CURRENTS_LEN   12
#define EPS_COM_SOLAR_PANELS_CURRENTS_POS   (EPS_COM_SOLAR_PANELS_VOLTAGES_POS + EPS_COM_SOLAR_PANELS_VOLTAGES_LEN)

// Satellite Energy Level
#define EPS_COM_ENERGY_LEVEL_LEN            1
#define EPS_COM_ENERGY_LEVEL_POS            (EPS_COM_SOLAR_PANELS_CURRENTS_POS + EPS_COM_SOLAR_PANELS_CURRENTS_LEN)
