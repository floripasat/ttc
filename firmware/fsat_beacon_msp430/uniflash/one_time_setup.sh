...
ln -sf "$scriptDir"/ccs_base/common/bin/libstdc++.so.6.0.19 "$scriptDir"/ccs_base/common/bin/libstdc++.so
ln -sf "$scriptDir"/ccs_base/common/bin/libstdc++.so.6.0.19 "$scriptDir"/ccs_base/common/bin/libstdc++.so.6
