...
\begin{itemize}
	\item The components and traces of the board are distributed over two layers.
	\item The RF modules are placed in a isolated ground plane (Connected to the main GND using a ferrite bead).
